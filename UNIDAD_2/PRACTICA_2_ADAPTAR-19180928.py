...
class Perceptron(object):
    # ... (codigo existente de la clase Perceptron)

    @staticmethod
    def leer_datos_desde_csv(ruta_archivo):
        # Lee los datos desde un archivo CSV y retorna X e y
    ...
    def cargar_nuevos_datos(self, ruta_archivo):
        # Metodo para cargar nuevos datos
        X, y = self.leer_datos_desde_csv(ruta_archivo)
        return X, y
...
# Cargar nuevos datos utilizando el metodo cargar_nuevos_datos
nuevos_X, nuevos_y = ppn.cargar_nuevos_datos('C:\Users\CIENCIAS BASICAS 01\Desktop\import pandas as pd.py')

# Entrenar el Perceptron con los nuevos datos
ppn.fit(nuevos_X, nuevos_y)

# Visualizar el modelo, hacer predicciones, etc.
# ... (codigo restante para visualizar y trabajar con el modelo)
